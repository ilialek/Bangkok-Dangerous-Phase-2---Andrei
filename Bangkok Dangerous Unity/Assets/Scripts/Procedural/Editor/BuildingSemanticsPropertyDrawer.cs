...
{
    [CustomPropertyDrawer(typeof(BuildingSemantic))]
    public class BuildingSemanticsPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                BuildingSemantic target = property.objectReferenceValue as BuildingSemantic;
                if (target != null)
                {
